...
**[Documentation & Playground](https://alexandroit.github.io/client-errors/)** | **[npm](https://www.npmjs.com/package/@revivejs/client-errors)** | **[Issues](https://github.com/alexandroit/client-errors/issues)** | **[Repository](https://github.com/alexandroit/client-errors)**
...
3. [Pure POST With No Authentication](#pure-post-with-no-authentication)
4. [Bearer Token Example](#bearer-token-example)
5. [Custom Headers Example](#custom-headers-example)
6. [Dynamic Headers Example](#dynamic-headers-example)
7. [Screenshot Example](#screenshot-example)
8. [Sanitization Example](#sanitization-example)
9. [Manual Capture Example](#manual-capture-example)
10. [Relative Endpoints](#relative-endpoints)
